...
public class DaySevenTest
{
    ...
    public void testPartOneExampleOne ( )
    {
        ...
        assertEquals ( "CABDFE", DaySeven.partOne ( input ) );
    }
    ...
    public void testPartTwoExampleOne ( )
    {
        ...
        assertEquals ( 15, DaySeven.partTwo ( input, 2, 0 ) );
    }

    @Test
    public void testPartOneActual ( )
    {
        String input = "Step I must be finished before step G can begin.\n" +
        ...
        System.out.println ( "Part One Answer " + DaySeven.partOne ( input ) );
    }
    ...
    public void testPartTwoActual ( )
    {
        ...
        System.out.println ( "Part Two Answer " + DaySeven.partTwo ( input, 5, 60 ) );
    }
}
